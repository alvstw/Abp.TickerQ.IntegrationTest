...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 4df0716d-801d-4ba0-b730-423a21a75c2a
```

> `4df0716d-801d-4ba0-b730-423a21a75c2a` is the password of the certificate, you can change it to any password you want.
